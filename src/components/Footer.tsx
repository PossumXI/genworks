        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              An AI-powered creative development ecosystem for the next generation of software builders.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/hub" className="text-gray-400 hover:text-white transition-colors">Prompt & Result Hub</a>
              </li>
              <li>
                <a href="/deepwiki" className="text-gray-400 hover:text-white transition-colors">DeepWiki IDE</a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} GenWorks. All rights reserved.
            </p>
